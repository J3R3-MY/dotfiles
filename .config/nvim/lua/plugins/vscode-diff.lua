    ...
    require("codediff").setup({
      ...
      keymaps = {
        view = {
          ...
          next_hunk = "<leader>h",              -- Jump to next change
          prev_hunk = "<leader><h",              -- Jump to previous change
          next_file = "<leader>>f",              -- Next file in explorer mode
          prev_file = "<leader><f",              -- Previous file in explorer mode
        ...
        conflict = {
          ...
          next_conflict = "<leader>>x",           -- Jump to next conflict
          prev_conflict = "<leader><x",           -- Jump to previous conflict
